...
python avg_plotting.py -i r1_6jwh_113-580_charmm36_ZF1.tab -c 4 -plot -box -avg -o r1_6jwh_113-580_charmm36_ZF1 -ref 3.835
...
python avg_plotting.py -i r1_6jwh_113-580_charmm36_ZF2.tab -c 4 -plot -box -avg -o r1_6jwh_113-580_charmm36_ZF2 -ref 3.902
