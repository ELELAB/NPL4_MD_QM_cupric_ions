...
%fullout
6 1
1 2 3 4 5" > r3_6jwh_129-151_charmm36.dat

shape r3_6jwh_129-151_charmm36.dat

python avg_plotting.py -i r3_6jwh_129-151_charmm36.tab -c 6 -plot -box -avg -o r3_6jwh_129-151_charmm36 -ref 0.810
