...
%fullout
6 1
1 2 3 4 5" > r1_6jwh_129-151_charmm36.dat

shape r1_6jwh_129-151_charmm36.dat

python avg_plotting.py -i r1_6jwh_129-151_charmm36.tab -c 6 -plot -box -avg -o r1_6jwh_129-151_charmm36 -ref 0.810
