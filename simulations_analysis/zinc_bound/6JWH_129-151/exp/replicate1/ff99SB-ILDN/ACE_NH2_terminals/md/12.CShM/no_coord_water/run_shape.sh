...
%fullout
4 1
1 2 3 4 " > r1_6jwh_129-151_ff99SB-ILDN.dat

shape r1_6jwh_129-151_ff99SB-ILDN.dat

python avg_plotting.py -i r1_6jwh_129-151_ff99SB-ILDN.tab -c 4 -plot -box -avg -o r1_6jwh_129-151_ff99SB-ILDN -ref 0.810
