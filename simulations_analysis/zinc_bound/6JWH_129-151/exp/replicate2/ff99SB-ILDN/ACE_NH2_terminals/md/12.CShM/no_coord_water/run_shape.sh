...
%fullout
4 1
1 2 3 4 " > r2_6jwh_129-151_ff99SB-ILDN.dat

shape r2_6jwh_129-151_ff99SB-ILDN.dat

python avg_plotting.py -i r2_6jwh_129-151_ff99SB-ILDN.tab -c 4 -plot -box -avg -o r2_6jwh_129-151_ff99SB-ILDN -ref 0.810
