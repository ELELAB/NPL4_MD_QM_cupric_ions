...
def plot_md(d,
    ...
    # # CHARM22*
    # ###########
    # for (columnName, columnData) in d['ZF1']['charmm22']['his139'].iteritems():
    ...
    # for (columnName, columnData) in d['ZF1']['charmm22']['cys137'].iteritems():
    #     sns.distplot(columnData,
    #                  hist=False,
    #                  label=columnName,
    #                  ax=axs[1][0])
    ...
    # for (columnName, columnData) in d['ZF1']['charmm22']['cys145'].iteritems():
    #     sns.distplot(columnData,
    #                  hist=False,
    #                  label=columnName,
    #                  ax=axs[2][0])
    ...
    # for (columnName, columnData) in d['ZF1']['charmm22']['cys148'].iteritems():
    #     sns.distplot(columnData,
    #                  hist=False,
    ...
    # axs[0, 0].set_title('CHARMM22* (His139)',
    #                      fontweight="bold")
    # axs[1, 0].set_title('CHARMM22* (Cys137)',
    #                      fontweight="bold")
    # axs[2, 0].set_title('CHARMM22* (Cys145)',
    #                      fontweight="bold")
    # axs[3, 0].set_title('CHARMM22* (Cys148)',
    #                      fontweight="bold")
    # axs[0, 0].set_xlabel('')
    # axs[1, 0].set_xlabel('')
    # axs[2, 0].set_xlabel('')
    ...
    axs[0, 0].set_title('CHARMM36 (His139)',
                         fontweight="bold")
    axs[1, 0].set_title('CHARMM36 (Cys137)',
                        fontweight="bold")
    axs[2, 0].set_title('CHARMM36 (Cys145)',
                        fontweight="bold")
    axs[3, 0].set_title('CHARMM36 (Cys148)',
                        fontweight="bold")
    axs[0, 0].set_xlabel('')
    axs[1, 0].set_xlabel('')
    axs[2, 0].set_xlabel('')
    ...
    axs[0, 2].set_title('ff99SB*-ILDN (His139)',
                        fontweight="bold")
    axs[1, 2].set_title('ff99SB*-ILDN (Cys137)',
                        fontweight="bold")
    axs[2, 2].set_title('ff99SB*-ILDN (Cys145)',
                        fontweight="bold")
    axs[3, 2].set_title('ff99SB*-ILDN (Cys148)',
                        fontweight="bold")
    axs[0, 2].set_xlabel('')
    axs[1, 2].set_xlabel('')
    axs[2, 2].set_xlabel('')
